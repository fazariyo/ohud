...
// Sticky, always-visible WhatsApp booking button (Blueprint §3.5, §3.9).
// Booking is WhatsApp-first: this is the fastest path from any page to a booking.
export default function WhatsAppFab() {
  return (
    ...
    >
      ...
      <span className="wa-label">Book on WhatsApp</span>
    </a>
  );
}
