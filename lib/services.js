...
export const services = [
  {
    ...
    faqs: [
      ...
      { q: 'Why is your price lower than the big clinics?', a: 'Because we publish a fair, fixed price instead of quoting high and negotiating down. The quality of the materials and the care does not change with the price tag.' },
  ...
  },
  {
    ...
    lead: 'Straight teeth are easier to clean and healthier for life — not just better looking. We offer metal braces, tooth-coloured ceramic, and clear aligners, with the full treatment price fixed up front and payable in instalments.',
    whatItIs:
    ...
    howWeDoIt: [
      { step: 'We assess and quote', text: 'A full assessment and a single, fixed price for the whole treatment — no per-visit surprises.' },
    ...
    whatWeUse:
      'Quality bracket systems and lab-made aligners. The full-treatment price is fixed at the start and includes routine adjustments.',
    pricing: [
    ...
    stories: [
      { name: 'Ali', area: 'Garden Town', quote: 'One fixed price for the whole treatment, in instalments. No “extra adjustment fee” every visit like other places.' },
    ...
    faqs: [
      ...
      { q: 'Is the price really fixed?', a: 'Yes. The full-treatment price is agreed at the start and includes routine adjustments, payable in instalments. No per-visit surprises.' },
  ...
  },
  {
    ...
    whatWeUse:
      'Child-safe, tooth-coloured materials and a patient, unhurried approach. Female team members available on request through the Ohud Sisters pathway.',
    pricing: [
    ...
    faqs: [
      ...
      { q: 'Do you have a female dentist for my daughter?', a: 'Yes — our Ohud Sisters pathway means a female dentist and assistant can care for your daughter. Just ask when booking.' },
    ],
...
// The lead dentist is the brand's voice; the women's pathway has a named female lead.
export const team = [
  ...
  { photo: 7904406, name: 'Dr. Hira Naqvi', role: 'Lead Dentist — Ohud Sisters', bio: 'Dr. Hira leads our women’s pathway. She cares for female patients and children with a female assistant present, in a calm setting designed around comfort and modesty.', tags: ["Women's Care", "Children's Dentistry", 'Cosmetic'], pmdc: 'PMDC verified' },
  { photo: 6762869, name: 'Dr. Faisal Khan', role: 'Orthodontist', bio: 'Dr. Faisal straightens smiles of all ages with braces and clear aligners — known for his patience with anxious teens and for quoting one fixed price for the whole treatment.', tags: ['Braces', 'Clear Aligners'], pmdc: 'PMDC verified' },
