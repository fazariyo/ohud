...
export const services = [
  {
    ...
    pricing: [
      { name: 'Root canal treatment', price: '15,000' },
      { name: 'Re-treatment (re-doing an old RCT)', price: '15,000' },
      { name: 'Protective crown (PFM)', price: '18,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      { name: 'Metal crown (manual)', price: '12,000' },
      { name: 'Metal crown', price: '18,000' },
      { name: 'PFM crown', price: '18,000' },
      { name: 'Zirconia crown', price: '30,000' },
      { name: 'E-Max crown', price: '35,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      { name: 'Scaling & polishing', price: '5,000' },
      { name: 'Deep cleaning', price: '12,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      { name: 'Simple extraction', price: '5,000' },
      { name: 'Surgical extraction', price: '8,000 – 10,000' },
      { name: 'Wisdom tooth (surgical)', price: '18,000 – 20,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      { name: 'Tooth-coloured composite filling', price: '5,000 – 6,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      { name: 'Porcelain veneer (per tooth)', price: '25,000' },
      { name: 'Composite veneers (full set)', price: '50,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      ...
      { name: 'Scaling first (if your teeth need it)', price: '5,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      { name: 'Dental implant with PFM crown', price: '100,000' },
      { name: 'Dental implant with zirconia crown', price: '110,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      ...
      { name: 'Clear aligners (full treatment)', price: '150,000 – 170,000' },
      { name: 'Retainer', price: '8,000' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      ...
      { name: "Child's filling", price: '4,000' },
      { name: "Child's extraction", price: '2,500' },
    ],
    stories: [
  ...
  },
  {
    ...
    pricing: [
      ...
      { name: 'Simple extraction (if needed)', price: '5,000' },
      { name: 'Root canal (if needed)', price: '15,000' },
    ],
    stories: [
